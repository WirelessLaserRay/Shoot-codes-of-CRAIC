...
class navigation_demo:
	...
	if (point_msg.z != 255 and move_flog == 0) :
            if(point_msg.z>=1 and point_msg.z<=5 and flog0 ==255):
                id = 1
                flog0 = 1 
            elif(point_msg.z>=6 and point_msg.z<=10 and flog1 ==255):
                id = 3
                flog1 = 3 
            elif(point_msg.z>=11 and point_msg.z<=15 and flog2 ==255):
                id = 5
                flog2 = 5 
            ...
            if(point_msg.z>=1 and point_msg.z<=5):
                id = 1
            elif(point_msg.z>=6 and point_msg.z<=10):
                id = 3
            elif(point_msg.z>=11 and point_msg.z<=15):
                id = 5
